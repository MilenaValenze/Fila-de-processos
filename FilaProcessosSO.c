...
//adicionar: first2, pq a fila de prioritários pode estar vazia.
...
List *New, *first1, *last1, *aux, *first2, *last2; //New é o novo processo. first1 é o primeiro da fila(prioritário). last1 é o último dos prioritarios
